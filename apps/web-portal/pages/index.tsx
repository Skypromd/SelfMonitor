    ...
    <div className={styles.lpRoot}>
      ...
      <header className={styles.lpNav}>
        <div className={styles.lpNavInner}>
          ...
          <a href="/login" className={styles.lpNavLink} style={{ opacity: 0.75 }}>Sign In</a>
        ...
        {menuOpen && (
          <div className={styles.lpNavMobileMenu}>
            ...
            <a href="/login" className={styles.lpNavMobileLink} onClick={() => setMenuOpen(false)}>Sign In</a>
      ...
      <footer className={styles.lpFooter}>
        ...
        <a
          ...
          onMouseEnter={e => (e.currentTarget.style.color = 'rgba(13,148,136,0.6)')}
