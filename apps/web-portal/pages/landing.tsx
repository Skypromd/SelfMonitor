    ...
    <>
      ...
      <nav className={styles.navbar}>
        <div className={styles.navInner}>
          <span className={styles.navBrand}>SelfMonitor</span>
          <div className={styles.navLinks}>
            <a href="#features">Features</a>
            <a href="#pricing">Pricing</a>
            <a href="#testimonials">Reviews</a>
          </div>
          <Link href="/" className={styles.btnPrimary} style={{ height: '38px', padding: '0 1.25rem', fontSize: '0.9rem' }}>
            Sign In
          </Link>
        </div>
      </nav>
      ...
      <div className={styles.page}>
        ...
        <section className={styles.hero}>
          <div className={styles.container}>
            ...
            >
              <span className={styles.heroBadge}>🇬🇧 Built for UK Self-Employed Professionals</span>
              <h1 className={styles.heroHeadline}>
                Financial Freedom for<br />the Self-Employed
              </h1>
            ...
            >
              ...
              <span className={styles.trustPill}>✅ MTD Ready</span>
            </motion.div>
            ...
            >
              <div className={styles.statItem}>
                <span className={styles.statValue}><AnimatedCounter target={2400} suffix="+" /></span>
              ...
              <div className={styles.statItem}>
                <span className={styles.statValue}><AnimatedCounter target={94} suffix="%" /></span>
          ...
          <div className={styles.container}>
            ...
            <motion.div className={styles.grid3} {...staggerContainer}>
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <h3 className={styles.cardTitle}>Hours lost on manual bookkeeping</h3>
        ...
        <section id="features" className={styles.sectionElevated}>
          <div className={styles.container}>
            <motion.div {...fadeUp}>
              <h2 className={styles.sectionHeading}>One Platform. Every Tool You Need.</h2>
              <p className={styles.sectionSub}>From bank connection to tax submission — automated.</p>
            </motion.div>
            ...
            <motion.div className={styles.grid3} {...staggerContainer}>
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>
                  Connect your banks. Transactions import automatically via secure Open Banking APIs.
                </p>
              </motion.div>
              ...
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>
                  Every transaction categorized instantly by AI. No more manual tagging.
                </p>
              </motion.div>
              ...
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>
                  Snap a photo. OCR extracts vendor, amount, and date in seconds.
                </p>
              </motion.div>
              ...
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>
                  Real-time UK tax estimates. One-click HMRC submission when you&rsquo;re ready.
                </p>
              </motion.div>
              ...
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>30-day AI predictions so you never run out of cash.</p>
              </motion.div>
              ...
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>
                  Ask &ldquo;Where did I buy coffee last month?&rdquo; — AI finds it instantly.
                </p>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className={styles.container}>
            ...
            <motion.div className={styles.grid4} {...staggerContainer}>
              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>Track project income, expenses, and IR35 status effortlessly.</p>
              </motion.div>

              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                <span className={styles.cardIcon}>🎨</span>
                <h3 className={styles.cardTitle}>Designers &amp; Creatives</h3>
                <p className={styles.cardDesc}>Receipt scanning, client invoicing, and portfolio expense tracking.</p>
              </motion.div>

              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                <span className={styles.cardIcon}>🚗</span>
                <h3 className={styles.cardTitle}>Sole Traders</h3>
                <p className={styles.cardDesc}>Mileage tracking, stock expenses, and quarterly VAT — sorted.</p>
              </motion.div>

              <motion.div className={`${styles.card} ${styles.cardOnElevated}`} {...staggerItem}>
                <span className={styles.cardIcon}>📋</span>
                <h3 className={styles.cardTitle}>Consultants</h3>
                <p className={styles.cardDesc}>Multi-client billing, expense reports, and tax forecasting in one place.</p>
              </motion.div>
            </motion.div>
          </div>
        </section>
          ...
          <div className={styles.container}>
            ...
            <motion.div className={styles.grid4} {...staggerContainer}>
              <motion.div className={styles.card} {...staggerItem}>
                ...
                <p className={styles.cardDesc}>TOTP-based 2FA with authenticator apps. Your account stays yours.</p>
              </motion.div>

              <motion.div className={styles.card} {...staggerItem}>
                <span className={styles.cardIcon}>🛡️</span>
                <h3 className={styles.cardTitle}>Fraud Detection</h3>
                <p className={styles.cardDesc}>Real-time anomaly detection with ML scoring flags suspicious activity.</p>
              </motion.div>

              <motion.div className={styles.card} {...staggerItem}>
                <span className={styles.cardIcon}>📋</span>
                <h3 className={styles.cardTitle}>Audit Trail</h3>
                <p className={styles.cardDesc}>Every action logged. Full GDPR compliance baked in from day one.</p>
              </motion.div>

              <motion.div className={styles.card} {...staggerItem}>
                <span className={styles.cardIcon}>🔒</span>
                <h3 className={styles.cardTitle}>Encrypted Storage</h3>
                <p className={styles.cardDesc}>Vault-secured credentials. S3-encrypted documents. Zero compromise.</p>
              </motion.div>
            </motion.div>
          </div>
        </section>
          ...
          <div className={styles.container}>
            ...
            <motion.div className={styles.roiSection} {...fadeUp}>
              ...
              <div className={`${styles.roiColumn} ${styles.roiColumnGood}`}>
                ...
                <div className={styles.roiItem}>
                  ...
                  <span className={styles.roiItemValueGood}>£15/month</span>
                </div>
                <div className={styles.roiItem}>
                  <span className={styles.roiItemLabel}>Total cost</span>
                  <span className={styles.roiItemValueGood}>£180/yr</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeUp} style={{ textAlign: 'center', marginTop: '2.5rem' }}>
              <p className={styles.roiTotal}>
                <AnimatedCounter target={2520} prefix="£" />/year
              </p>
