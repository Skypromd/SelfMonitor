            ...
            <div className={styles.mobileShowcase}>
              <motion.div className={styles.mobileContent} {...fadeUp}>
                ...
                <div className={styles.storeButtonsLeft}>
                  ...
                  <a href="https://play.google.com/store/apps/details?id=com.mynettax.app" className={styles.storeButton} target="_blank" rel="noopener noreferrer">
                    <span className={`${styles.storeIconWrap} ${ACCENT.greenPlay}`} aria-hidden>
                      <Play size={22} strokeWidth={2} />
                    </span>
                    <span className={styles.storeText}>
            ...
            <div className={styles.footerTop}>
              ...
              <div>
                ...
                <ul className={styles.footerLinks}>
                  ...
                  <li><a href="https://play.google.com/store/apps/details?id=com.mynettax.app" target="_blank" rel="noopener noreferrer">Android App</a></li>
