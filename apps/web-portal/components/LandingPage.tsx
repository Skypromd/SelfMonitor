...
const PRICING_PLANS: ReadonlyArray<{
...
}> = [
  {
    ...
    price: '£15',
    features: [
      { icon: Landmark, text: '1 Open Banking connection' },
      { icon: BarChart3, text: 'Up to 500 transactions / month' },
      { icon: Sparkles, text: 'AI auto-categorisation & UK merchant patterns' },
      { icon: Receipt, text: 'Receipt capture & OCR' },
      { icon: CalendarClock, text: 'HMRC calendar & filing reminders' },
  ...
  },
  {
    ...
    price: '£18',
    features: [
      { icon: Landmark, text: '2 Open Banking connections' },
      { icon: BarChart3, text: 'Up to 2,000 transactions / month' },
  ...
  },
  {
    ...
    popular: true,
    features: [
      { icon: Landmark, text: '3 Open Banking connections' },
      { icon: BarChart3, text: 'Up to 5,000 transactions / month' },
      { icon: Bot, text: 'SelfMate AI assistant (unlimited)' },
      { icon: FileCheck, text: 'HMRC MTD calculations & submission' },
  ...
  },
  {
    ...
    price: '£30',
    features: [
      { icon: Landmark, text: 'Up to 5 Open Banking connections' },
