...
class UserProfileBase(BaseModel):
    ...
    language: Optional[str] = Field(
        default="en", description="User language preference"
    )
    currency: Optional[str] = Field(
        default="USD", description="User currency preference"
    )
...
class SubscriptionBase(BaseModel):
    ...
    billing_cycle: str = Field(
        default="monthly", description="Billing cycle (monthly)."
    )
...
class SubscriptionUpdate(BaseModel):
    """Schema for updating subscription fields only."""
