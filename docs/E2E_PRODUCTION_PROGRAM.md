...
Ниже — оценка **полного 12‑фазного плана** (как у внешнего советника), сопоставление с **текущим репозиторием MyNetTax** и **практический backlog** для воплощения. Детальный техдолг по сервисам по‑прежнему ведётся в **`docs/TODO_PRODUCTION.md`**.
...
*Создано для сопоставления внешнего E2E плана с кодовой базой MyNetTax.*
