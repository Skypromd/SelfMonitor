...
- branded splash layer with remote-configurable theme/copy;
- onboarding A/B experiment assignment (stable bucket by installation ID);
...
- mobile analytics funnel events (splash, onboarding, biometric, push permission, deep-link opens).
